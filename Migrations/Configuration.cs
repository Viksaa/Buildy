    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Buildy.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Buildy.Models.ApplicationDbContext context)
        {
            ...
            context.Motherboards.AddOrUpdate(x => x.Id,
                ...
                new Motherboard() { Id = 25, Name = "MPG Z390 GAMING PLUS", ChipsetId = 1, DimmSlots = 4, MotherboardTypeId = 1, ManufacturerId = 4, MemorySupport = 64, SocketId = 1, Price = 140, ImageURL = "https://cdn.pcpartpicker.com/static/forever/images/product/f68bd53f6c04fd23f6c3f2a1dfdaa1e2.1600.jpg" }
                );
